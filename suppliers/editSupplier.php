...
if (isset($_POST['Enviar'])) {
    ...
    $Categoria = "Edição";
    $Mensagem = $nome_fornecedor . " editado(a) com sucesso";
    ...
    if ($result) {
        ...
        $rowsFornecedores = [
            $row['nome_fornecedor'],
            $row['endereco_fornecedor'],
            $row['telefone_fornecedor'],
            $row['email'],
        ];
        ...
        for ($i = 0; $i < count($rowsFornecedores); $i++) {
            $valueFornecedores = $rowsFornecedores[$i];
            $valueCollumn = $collumnFornecedores[$i];

            if ($valueFornecedores != $valueCollumn) {
                $sql2 = "INSERT INTO historico_acoes_fornecedores (funcionario_id, categoria, acao, dataRegistrada, dadoAnterior, dadoAlterado
            ) VALUES (
            '$IdFuncionario', '$Categoria', '$Mensagem', '$dataRegistrada', '$valueFornecedores', '$valueCollumn')";
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control nome_fornecedor" name="nome_fornecedor"
                                            ...
                                            value="<?php echo $row['nome_fornecedor'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control endereco_fornecedor"
                                            ...
                                            value="<?php echo $row['endereco_fornecedor'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control telefone_fornecedor"
                                            ...
                                            value="<?php echo $row['telefone_fornecedor'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="email" class="form-control email" name="email"
                                            placeholder="Email do Fornecedor" value="<?php echo $row['email'] ?>">
                                    </div>
                                </div>
