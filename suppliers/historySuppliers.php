    ...
    <div class="card-body">
        ...
        <table class="table table-borderless datatable">
            ...
            <tbody>
                ...
                $sql2 = "SELECT *, funcionarios.nomeFuncionario as 'Funcionário' FROM historico_acoes_fornecedores INNER JOIN funcionarios on funcionarios.id = historico_acoes_fornecedores.funcionario_id ORDER BY historico_acoes_fornecedores.id DESC";
